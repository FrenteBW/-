//
//  BarbellrowDescriptionView.swift
//  AITrainer
//
...
struct BarbellrowDescriptionView: View {
        ...
        NavigationView {
            ZStack{
                VStack(spacing: 0.0){
                    ...
                    NavigationLink{
                        BarbellrowMainView().navigationViewStyle(StackNavigationViewStyle())
                    } label: {
                        LargeButton()
                            .padding(.bottom, 30)
...
struct BarbellrowDescriptionView_Previews: PreviewProvider {
    static var previews: some View {
        BarbellrowDescriptionView()
    }
}
