//
//  LateralraiseDescriptionView.swift
//  AITrainer
//
...
struct LateralraiseDescriptionView: View {
        ...
        NavigationView {
            ZStack{
                VStack(spacing: 0.0){
                    ...
                    NavigationLink{
                        LateralraiseMainView().navigationViewStyle(StackNavigationViewStyle())
                    } label: {
                        LargeButton()
                            .padding(.bottom, 30)
...
struct LateralraiseDescriptionView_Previews: PreviewProvider {
    static var previews: some View {
        LateralraiseDescriptionView()
    }
}
