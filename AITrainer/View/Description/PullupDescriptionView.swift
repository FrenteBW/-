...
struct PullupDescriptionView: View {
        ...
        NavigationView {
            ZStack{
                VStack(spacing: 0.0){
                    ...
                    NavigationLink{
                        PullupMainView().navigationViewStyle(StackNavigationViewStyle())
                    } label: {
                        LargeButton()
                            .padding(.bottom, 30)
...
struct PullupDescriptionView_Previews: PreviewProvider {
    static var previews: some View {
        PullupDescriptionView()
    }
}
