//
//  InclinepressDescriptionView.swift
//  AITrainer
//
...
struct InclinepressDescriptionView: View {
        ...
        NavigationView {
            ZStack{
                VStack(spacing: 0.0){
                    ...
                    NavigationLink{
                        InclinepressMainView().navigationViewStyle(StackNavigationViewStyle())
                    } label: {
                        LargeButton()
                            .padding(.bottom, 30)
...
struct InclinepressDescriptionView_Previews: PreviewProvider {
    static var previews: some View {
        InclinepressDescriptionView()
    }
}
