...
struct DeadliftDescriptionView: View {
        ...
        NavigationView {
            ZStack{
                VStack(spacing: 0.0){
                    ...
                    NavigationLink{
                        DeadliftMainView().navigationViewStyle(StackNavigationViewStyle())
                    } label: {
                        LargeButton()
                            .padding(.bottom, 30)
...
struct DeadliftDescriptionView_Previews: PreviewProvider {
    static var previews: some View {
        DeadliftDescriptionView()
    }
}
