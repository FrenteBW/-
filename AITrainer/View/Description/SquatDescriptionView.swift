...
struct SquatDescriptionView: View {
        ...
        NavigationView {
                ZStack{
                    VStack(spacing: 0.0){
                        ...
                        NavigationLink{
                            SquatMainView().navigationViewStyle(StackNavigationViewStyle())
                        } label: {
                            LargeButton()
                                .padding(.bottom, 30)
...
struct SquatDescriptionView_Previews: PreviewProvider {
    static var previews: some View {
        SquatDescriptionView()
    }
}
