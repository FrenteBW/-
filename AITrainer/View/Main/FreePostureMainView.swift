...
struct FreePostureMainView: View {
            ...
            VStack {
                ZStack {
                    GeometryReader { geo in
                        ...
                        FreePostureStickFigureView(poseEstimator: poseEstimator, size: geo.size)
                    }
...
struct FreePostureMainView_Previews: PreviewProvider {
